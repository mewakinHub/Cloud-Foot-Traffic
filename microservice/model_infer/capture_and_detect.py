...
# Define constants
youtube_url = 'https://www.youtube.com/live/gFRtAAmiFbE?si=UcvSaJZnHK5k9Xje'
...
if capture_best_frame():
    ...
    cv2.putText(detected_frame, f"People Count: {people_count}", (10, 30),
                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
    cv2.putText(detected_frame, f"Source: {youtube_url}", (10, 60),
